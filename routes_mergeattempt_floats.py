...
def TwoBeach():
	...
	cursor.close()
	return render_template('TwoBeach.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Narragansett():
	...
	#code responsible for graphing the pygal chart ... using data from the DB, from list objects mylist & newl
	graph = pygal.Line()
	graph.title = 'Narragansett Beach 7 Day Surf Forecast'
	graph.x_labels = mylist
	graph.add('Avg Wave Height',  mmm)
	graph_data = graph.render_data_uri()
	#original code, used for creating table in Nahant.html
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Narragansett.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Ruggles():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Ruggles.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Nantasket():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Nantasket.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Scituate():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Scituate.html', selected='submit', info1=info1, graph_data=graph_data)
...
def CapeCod():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('CapeCod.html', selected='submit', info1=info1, graph_data=graph_data)
...
def GreenHarbor():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('GreenHarbor.html', selected='submit', info1=info1, graph_data=graph_data)
...
def CapeAnn():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('CapeAnn.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Devereux():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Devereux.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Salisbury():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Salisbury.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Plymouth():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Plymouth.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Rye():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Rye.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Hampton():
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Hampton.html', selected='submit', info1=info1, graph_data=graph_data)
...
def Seabrook():
	...
	#code responsible for graphing the pygal chart ... using data from the DB, from list objects mylist & newl
	graph = pygal.Line()
	graph.title = 'Seabrook 7 Day Surf Forecast'
	graph.x_labels = mylist
	graph.add('Avg Wave Height',  mmm)
	graph_data = graph.render_data_uri()
	#original code, used for creating table in Nahant.html
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('Seabrook.html', selected='submit', info1=info1, graph_data=graph_data)
...
def NHSeacoast():
	...
	#code responsible for graphing the pygal chart ... using data from the DB, from list objects mylist & newl
	graph = pygal.Line()
	graph.title = 'NHSeacoast 7 Day Surf Forecast'
	graph.x_labels = mylist
	graph.add('Avg Wave Height',  mmm)
	graph_data = graph.render_data_uri()
	#original code, used for creating table in Nahant.html
	...
	info1 = [dict(SwellSize=row[0], SwellInterval=row[1], WindSpeed=row[2], WindDescription=row[3], AirTemperature=row[4], Beach=row[5], Day=row[6], Tiempo=row[7], St8=row[8]) for row in cursor.fetchall()]
	cursor.close()
	return render_template('NHSeacoast.html', selected='submit', info1=info1, graph_data=graph_data)
